...
<header>
  <h2 style="text-align: center;">Email already exists. Please try new email or go to Login.</h2>
...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12 col-md-4 cols-md-4">
          <form action="signUp_process.php" class="form-container" method="post" enctype="multipart/form-data">
                <div class = "form-group">
                  <h4 class = "text-cent font-weight-bold">SIGN UP</h4>
